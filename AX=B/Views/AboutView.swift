                ...
                VStack {
                    ...
                    VStack{
                        Text("Acknowledgment")
                            ...
                            .font(.title)
                            .padding(EdgeInsets(top: 25, leading: 25, bottom: 0, trailing: 0))
                        Text("Special words of appreciation to Dale Moseley, David Womble, Joseph Bishop, and Clarizza Morales is warranted. Dale's, David's, Joseph's, and Clarizza's review comments helped to make this app much more robust and user friendly.")
                            .font( Font.system(size: 14))
                            .foregroundColor(Color.black)
                            .padding(EdgeInsets(top: 0, leading: 10, bottom: 0, trailing: 0))
